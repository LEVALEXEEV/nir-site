...
**2. Установка virtualenv.** Выполнено.
...
собирается дважды с разными адресами: для GitHub Pages и для Helios. Параметр `use_directory_urls` оставлен включённым: адреса вида
...
факт публикации именно текущей версии.
